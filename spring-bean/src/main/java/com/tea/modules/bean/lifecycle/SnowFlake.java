...
/*        Long redisWorkerId = redisTemplate.opsForValue().increment("snow");
        if (redisWorkerId > 31) {
            redisTemplate.opsForValue().set("snow", 0);
        }
        this.workerId = redisWorkerId;
    ...
    public synchronized long nextId() {
        ...
        return (currStmp-START_STAMP) << SEQUENCE_BIT << WORKER_BIT
